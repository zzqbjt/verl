...
ray job submit --address="http://127.0.0.1:8265" \
    ...
    -- python3 -m verl.trainer.main_ppo \
        ...
        actor_rollout_ref.actor.answer_log_prob_use_dynamic_bsz=${use_dynamic_bsz} \
        ...
        actor_rollout_ref.actor.answer_log_prob_max_token_len_per_gpu=${ppo_max_token_len} \
        ...
        actor_rollout_ref.actor.medium_ema_alpha=${medium_ema_alpha} \
        ...
        trainer.default_local_dir=/data2/zzn/models/verl_ckpts/test/Qwen3-1.7B-Base \
